...
cd /usr/bin
wget -O addss-p "https://raw.githubusercontent.com/raysdenni/AutoScriptSSHws/main/shadowsocks-plugin/addss-p.sh"
chmod +x addss-p
wget -O shadowhost "https://raw.githubusercontent.com/raysdenni/AutoScriptSSHws/main/shadowsocks-plugin/shadowhost.sh"
chmod +x shadowhost && shadowhost
wget -O delss "https://raw.githubusercontent.com/raysdenni/AutoScriptSSHws/main/shadowsocks/delss.sh"
cd
